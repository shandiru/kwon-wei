  ...
  return (
    <>
      <div className="flex h-screen w-full bg-[#0F0F0F] text-white overflow-hidden">
        ...
        {/* RIGHT SCROLL PANEL */}
        <div className="ml-[45%] w-[55%] h-full overflow-y-auto no-scrollbar px-12 py-14 relative">

          {/* FILTER BUTTONS */}
          <div className="flex gap-3 sticky top-0 bg-[#0F0F0F]/80 backdrop-blur py-4 z-10">
            <a className="px-5 py-2 border border-gray-600 rounded-md text-sm hover:bg-gray-800 transition" href="#maki">
              MAKI
            </a>
            <a className="px-5 py-2 border border-gray-600 rounded-md text-sm hover:bg-gray-800 transition" href="#uramaki">
              URAMAKI
            </a>
            <a className="px-5 py-2 border border-gray-600 rounded-md text-sm hover:bg-gray-800 transition" href="#special">
              SPECIAL ROLLS
            </a>
          </div>
          ...
          <section id="maki" className="mt-16">
            <h2 className="text-center text-4xl font-serif tracking-wide mb-10">
              <span className="opacity-70">— </span>MAKI<span className="opacity-70"> —</span>
            </h2>

            {menuData.maki.map((item, i) => (
              <div key={i} className="flex gap-6 mb-14">
                <img src={item.img} className="w-32 h-24 rounded-lg object-cover bg-black" />
          ...
          <section id="uramaki" className="mt-20">
            <h2 className="text-center text-4xl font-serif tracking-wide mb-10">
              <span className="opacity-70">— </span>URAMAKI<span className="opacity-70"> —</span>
            </h2>
          ...
          <section id="special" className="mt-20 mb-20">
            <h2 className="text-center text-4xl font-serif tracking-wide mb-10">
              <span className="opacity-70">— </span>SPECIAL ROLLS<span className="opacity-70"> —</span>
            </h2>
