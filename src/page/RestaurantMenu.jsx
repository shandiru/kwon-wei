...
const RestaurantMenu = () => {
  ...
  return (
    <div className="min-h-screen bg-neutral-950">
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-b from-black via-neutral-900 to-neutral-950 py-20 md:py-28">
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <div>
              <h1 className="font-serif text-5xl md:text-7xl font-bold text-white tracking-tight">Kwon Wei</h1>
              <p className="text-2xl md:text-3xl text-amber-500 font-serif mt-3">官围餐厅</p>
            </div>
            <p className="text-lg md:text-xl text-neutral-400 max-w-xl mx-auto leading-relaxed">
              Authentic Cantonese & Sichuan cuisine with a modern twist. Every dish tells a story of tradition and passion.
            </p>
